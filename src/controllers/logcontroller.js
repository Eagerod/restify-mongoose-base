...
*/
function getLogs(Log, req, res, next) {
...
function LogController(database) {
    this.database = database;
}

LogController.prototype.get = function() {
    return {
        handler: getLogs.bind(null, this.database.models.Log)
    };
};
